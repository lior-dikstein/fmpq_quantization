...
from constants import TIMM, TORCHVISION
...
class VisionModel(BaseModel):
    ...
    def _init_float_model(self):
        with open(os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), 'models_config.yaml'), 'r') as f:
    ...
    def get_representative_dataset(self, sub_ds, shuffle, is_training, num_workers=4):
    ...
    def get_validation_data_loader(self, num_workers=10):
